...
class Ui_BusquedaPatron(object):
    ...
    def listaPatrones(self):
        ...
        with open("conf.json", 'r') as file:
            ...
            # entrar a cada carpeta y optener el archivo data.json
            
            for carpeta in carpetas:
                with open(f"{path_repo}/{carpeta}/data.json", 'r') as file:
                    data = file.read()
                    data = json.loads(data)
                    # Agregar el patron a la tabla
                    self.tw_listaPatrones.insertRow(self.tw_listaPatrones.rowCount())
                    self.tw_listaPatrones.setItem(self.tw_listaPatrones.rowCount()-1, 0, QtWidgets.QTableWidgetItem(data['Nombre']))
                    self.tw_listaPatrones.setItem(self.tw_listaPatrones.rowCount()-1, 1, QtWidgets.QTableWidgetItem(data['Descripcion']))
